defmodule Cforum.Web do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: Cforum.Web
  ...
  def view do
    quote do
      use Phoenix.View, root: "lib/cforum/web/templates", namespace: Cforum.Web
      ...
      import Cforum.Web.Router.Helpers
      import Cforum.Web.ErrorHelpers
      import Cforum.Web.Helpers
      import Cforum.Web.Gettext
      import Cforum.Paginator
      import Cforum.Sortable
