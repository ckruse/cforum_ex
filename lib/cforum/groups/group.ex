defmodule Cforum.Groups.Group do
  use CforumWeb, :model
  ...
  schema "groups" do
    ...
    has_many(:permissions, Cforum.Groups.ForumGroupPermission, foreign_key: :group_id, on_replace: :delete)
  ...
  defp maybe_put_users(changeset, users), do: put_assoc(changeset, :users, Cforum.Users.get_users(users))
end
