defmodule Cforum.PrivMessages.PrivMessage do
  use CforumWeb, :model
  ...
  schema "priv_messages" do
    ...
    belongs_to(:sender, Cforum.Users.User, references: :user_id)
    belongs_to(:recipient, Cforum.Users.User, references: :user_id)
    belongs_to(:owner, Cforum.Users.User, references: :user_id)

    has_many(:messages, Cforum.PrivMessages.PrivMessage, references: :thread_id, foreign_key: :thread_id)
  ...
  defp maybe_set_sender_id(changeset, %Cforum.Users.User{} = user),
