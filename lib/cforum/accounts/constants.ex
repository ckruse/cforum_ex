defmodule Cforum.Accounts.Constants do
  defmacro __using__(_) do
    quote do
      ...
      @badge_retag "retag"
      @badge_visit_close_reopen "visit_close_reopen"
      ...
      @badge_create_close_reopen_vote "create_close_reopen_vote"
      ...
      @badge_types [
        ...
        @badge_downvote,
        @badge_retag,
        @badge_visit_close_reopen,
        @badge_create_tags,
        @badge_create_tag_synonym,
        @badge_edit_question,
        @badge_edit_answer,
        @badge_create_close_reopen_vote,
