...
--
-- Name: badge_medal_type_t; Type: TYPE; Schema: public; Owner: ckruse
--
...
ALTER TYPE public.badge_medal_type_t OWNER TO ckruse;

--
-- Name: cache_user_activity_delete_trigger(); Type: FUNCTION; Schema: public; Owner: ckruse
--
...
ALTER FUNCTION public.cache_user_activity_delete_trigger() OWNER TO ckruse;

--
-- Name: cache_user_activity_insert_update_trigger(); Type: FUNCTION; Schema: public; Owner: ckruse
--
...
ALTER FUNCTION public.cache_user_activity_insert_update_trigger() OWNER TO ckruse;

--
-- Name: cache_user_score_delete_trigger(); Type: FUNCTION; Schema: public; Owner: ckruse
--
...
ALTER FUNCTION public.cache_user_score_delete_trigger() OWNER TO ckruse;

--
-- Name: cache_user_score_insert_trigger(); Type: FUNCTION; Schema: public; Owner: ckruse
--
...
ALTER FUNCTION public.cache_user_score_insert_trigger() OWNER TO ckruse;

--
-- Name: cache_user_score_update_trigger(); Type: FUNCTION; Schema: public; Owner: ckruse
--
...
ALTER FUNCTION public.cache_user_score_update_trigger() OWNER TO ckruse;

--
-- Name: count_messages_delete_trigger(); Type: FUNCTION; Schema: public; Owner: ckruse
--
...
ALTER FUNCTION public.count_messages_delete_trigger() OWNER TO ckruse;

--
-- Name: count_messages_insert_forum_trigger(); Type: FUNCTION; Schema: public; Owner: ckruse
--
...
ALTER FUNCTION public.count_messages_insert_forum_trigger() OWNER TO ckruse;

--
-- Name: count_messages_insert_trigger(); Type: FUNCTION; Schema: public; Owner: ckruse
--
...
ALTER FUNCTION public.count_messages_insert_trigger() OWNER TO ckruse;

--
-- Name: count_messages_tag_delete_trigger(); Type: FUNCTION; Schema: public; Owner: ckruse
--
...
ALTER FUNCTION public.count_messages_tag_delete_trigger() OWNER TO ckruse;

--
-- Name: count_messages_tag_insert_trigger(); Type: FUNCTION; Schema: public; Owner: ckruse
--
...
ALTER FUNCTION public.count_messages_tag_insert_trigger() OWNER TO ckruse;

--
-- Name: count_messages_truncate_trigger(); Type: FUNCTION; Schema: public; Owner: ckruse
--
...
ALTER FUNCTION public.count_messages_truncate_trigger() OWNER TO ckruse;

--
-- Name: count_messages_update_trigger(); Type: FUNCTION; Schema: public; Owner: ckruse
--
...
ALTER FUNCTION public.count_messages_update_trigger() OWNER TO ckruse;

--
-- Name: count_threads_delete_trigger(); Type: FUNCTION; Schema: public; Owner: ckruse
--
...
ALTER FUNCTION public.count_threads_delete_trigger() OWNER TO ckruse;

--
-- Name: count_threads_insert_forum_trigger(); Type: FUNCTION; Schema: public; Owner: ckruse
--
...
ALTER FUNCTION public.count_threads_insert_forum_trigger() OWNER TO ckruse;

--
-- Name: count_threads_insert_trigger(); Type: FUNCTION; Schema: public; Owner: ckruse
--
...
ALTER FUNCTION public.count_threads_insert_trigger() OWNER TO ckruse;

--
-- Name: count_threads_truncate_trigger(); Type: FUNCTION; Schema: public; Owner: ckruse
--
...
ALTER FUNCTION public.count_threads_truncate_trigger() OWNER TO ckruse;

--
-- Name: count_threads_update_trigger(); Type: FUNCTION; Schema: public; Owner: ckruse
--
...
ALTER FUNCTION public.count_threads_update_trigger() OWNER TO ckruse;

--
-- Name: counter_table_get_count(name, bigint); Type: FUNCTION; Schema: public; Owner: ckruse
--
...
ALTER FUNCTION public.counter_table_get_count(v_table_name name, v_group_crit bigint) OWNER TO ckruse;

--
-- Name: gen_forum_stats(integer); Type: FUNCTION; Schema: public; Owner: ckruse
--
...
ALTER FUNCTION public.gen_forum_stats(p_forum_id integer) OWNER TO ckruse;

--
-- Name: messages__thread_set_latest_insert(); Type: FUNCTION; Schema: public; Owner: ckruse
--
...
CREATE FUNCTION public.messages__thread_set_latest_insert() RETURNS trigger
    ...
    AS $$
      BEGIN
        UPDATE threads SET latest_message = COALESCE((SELECT MAX(created_at) FROM messages WHERE thread_id = threads.thread_id AND deleted = false),(SELECT MAX(created_at) FROM messages WHERE thread_id = threads.thread_id), '1970-01-01 00:00:00') WHERE thread_id = NEW.thread_id;
        RETURN NULL;
      END;
      $$;


ALTER FUNCTION public.messages__thread_set_latest_insert() OWNER TO ckruse;

--
-- Name: messages__thread_set_latest_update_delete(); Type: FUNCTION; Schema: public; Owner: ckruse
--
...
CREATE FUNCTION public.messages__thread_set_latest_update_delete() RETURNS trigger
    ...
    AS $$
      BEGIN
        UPDATE threads SET latest_message = COALESCE((SELECT MAX(created_at) FROM messages WHERE thread_id = threads.thread_id AND deleted = false), (SELECT MAX(created_at) FROM messages WHERE thread_id = threads.thread_id), '1970-01-01 00:00:00') WHERE thread_id = OLD.thread_id;
        RETURN NULL;
      END;
      $$;


ALTER FUNCTION public.messages__thread_set_latest_update_delete() OWNER TO ckruse;

--
-- Name: search_document_before_insert(); Type: FUNCTION; Schema: public; Owner: ckruse
--
...
ALTER FUNCTION public.search_document_before_insert() OWNER TO ckruse;

--
-- Name: settings_unique_check__insert(); Type: FUNCTION; Schema: public; Owner: ckruse
--
...
ALTER FUNCTION public.settings_unique_check__insert() OWNER TO ckruse;

--
-- Name: settings_unique_check__update(); Type: FUNCTION; Schema: public; Owner: ckruse
--
...
ALTER FUNCTION public.settings_unique_check__update() OWNER TO ckruse;

--
-- Name: timestamp2local(timestamp without time zone, character varying); Type: FUNCTION; Schema: public; Owner: ckruse
--
...
ALTER FUNCTION public.timestamp2local(ts_p timestamp without time zone, tz_p character varying) OWNER TO ckruse;
...
--
-- Name: ar_internal_metadata; Type: TABLE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.ar_internal_metadata OWNER TO ckruse;

--
-- Name: attendees; Type: TABLE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.attendees OWNER TO ckruse;

--
-- Name: attendees_attendee_id_seq; Type: SEQUENCE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.attendees_attendee_id_seq OWNER TO ckruse;

--
-- Name: attendees_attendee_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ckruse
--
...
--
-- Name: auditing; Type: TABLE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.auditing OWNER TO ckruse;

--
-- Name: auditing_auditing_id_seq; Type: SEQUENCE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.auditing_auditing_id_seq OWNER TO ckruse;

--
-- Name: auditing_auditing_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ckruse
--
...
--
-- Name: badge_groups; Type: TABLE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.badge_groups OWNER TO ckruse;

--
-- Name: badge_groups_badge_group_id_seq; Type: SEQUENCE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.badge_groups_badge_group_id_seq OWNER TO ckruse;

--
-- Name: badge_groups_badge_group_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ckruse
--
...
--
-- Name: badges; Type: TABLE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.badges OWNER TO ckruse;

--
-- Name: badges_badge_groups; Type: TABLE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.badges_badge_groups OWNER TO ckruse;

--
-- Name: badges_badge_groups_badges_badge_group_id_seq; Type: SEQUENCE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.badges_badge_groups_badges_badge_group_id_seq OWNER TO ckruse;

--
-- Name: badges_badge_groups_badges_badge_group_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ckruse
--
...
--
-- Name: badges_badge_id_seq; Type: SEQUENCE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.badges_badge_id_seq OWNER TO ckruse;

--
-- Name: badges_badge_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ckruse
--
...
--
-- Name: badges_users; Type: TABLE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.badges_users OWNER TO ckruse;

--
-- Name: badges_users_badge_user_id_seq; Type: SEQUENCE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.badges_users_badge_user_id_seq OWNER TO ckruse;

--
-- Name: badges_users_badge_user_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ckruse
--
...
--
-- Name: cites; Type: TABLE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.cites OWNER TO ckruse;

--
-- Name: cites_cite_id_seq; Type: SEQUENCE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.cites_cite_id_seq OWNER TO ckruse;

--
-- Name: cites_cite_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ckruse
--
...
--
-- Name: cites_votes; Type: TABLE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.cites_votes OWNER TO ckruse;

--
-- Name: cites_votes_cite_vote_id_seq; Type: SEQUENCE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.cites_votes_cite_vote_id_seq OWNER TO ckruse;

--
-- Name: cites_votes_cite_vote_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ckruse
--
...
--
-- Name: close_votes; Type: TABLE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.close_votes OWNER TO ckruse;

--
-- Name: close_votes_close_vote_id_seq; Type: SEQUENCE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.close_votes_close_vote_id_seq OWNER TO ckruse;

--
-- Name: close_votes_close_vote_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ckruse
--
...
--
-- Name: close_votes_voters; Type: TABLE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.close_votes_voters OWNER TO ckruse;

--
-- Name: close_votes_voters_close_votes_voter_id_seq; Type: SEQUENCE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.close_votes_voters_close_votes_voter_id_seq OWNER TO ckruse;

--
-- Name: close_votes_voters_close_votes_voter_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ckruse
--
...
--
-- Name: counter_table; Type: TABLE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.counter_table OWNER TO ckruse;

--
-- Name: counter_table_count_id_seq; Type: SEQUENCE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.counter_table_count_id_seq OWNER TO ckruse;

--
-- Name: counter_table_count_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ckruse
--
...
--
-- Name: events; Type: TABLE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.events OWNER TO ckruse;

--
-- Name: events_event_id_seq; Type: SEQUENCE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.events_event_id_seq OWNER TO ckruse;

--
-- Name: events_event_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ckruse
--
...
--
-- Name: forum_stats; Type: TABLE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.forum_stats OWNER TO ckruse;

--
-- Name: forum_stats_forum_stat_id_seq; Type: SEQUENCE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.forum_stats_forum_stat_id_seq OWNER TO ckruse;

--
-- Name: forum_stats_forum_stat_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ckruse
--
...
--
-- Name: forums; Type: TABLE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.forums OWNER TO ckruse;

--
-- Name: forums_forum_id_seq; Type: SEQUENCE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.forums_forum_id_seq OWNER TO ckruse;

--
-- Name: forums_forum_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ckruse
--
...
--
-- Name: forums_groups_permissions; Type: TABLE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.forums_groups_permissions OWNER TO ckruse;

--
-- Name: forums_groups_permissions_forum_group_permission_id_seq; Type: SEQUENCE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.forums_groups_permissions_forum_group_permission_id_seq OWNER TO ckruse;

--
-- Name: forums_groups_permissions_forum_group_permission_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ckruse
--
...
--
-- Name: groups; Type: TABLE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.groups OWNER TO ckruse;

--
-- Name: groups_group_id_seq; Type: SEQUENCE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.groups_group_id_seq OWNER TO ckruse;

--
-- Name: groups_group_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ckruse
--
...
--
-- Name: groups_users; Type: TABLE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.groups_users OWNER TO ckruse;

--
-- Name: groups_users_group_user_id_seq; Type: SEQUENCE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.groups_users_group_user_id_seq OWNER TO ckruse;

--
-- Name: groups_users_group_user_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ckruse
--
...
--
-- Name: interesting_messages; Type: TABLE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.interesting_messages OWNER TO ckruse;

--
-- Name: interesting_messages_interesting_message_id_seq; Type: SEQUENCE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.interesting_messages_interesting_message_id_seq OWNER TO ckruse;

--
-- Name: interesting_messages_interesting_message_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ckruse
--
...
--
-- Name: invisible_threads; Type: TABLE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.invisible_threads OWNER TO ckruse;

--
-- Name: invisible_threads_invisible_thread_id_seq; Type: SEQUENCE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.invisible_threads_invisible_thread_id_seq OWNER TO ckruse;

--
-- Name: invisible_threads_invisible_thread_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ckruse
--
...
--
-- Name: media; Type: TABLE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.media OWNER TO ckruse;

--
-- Name: media_medium_id_seq; Type: SEQUENCE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.media_medium_id_seq OWNER TO ckruse;

--
-- Name: media_medium_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ckruse
--
...
--
-- Name: message_references; Type: TABLE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.message_references OWNER TO ckruse;

--
-- Name: message_references_message_reference_id_seq; Type: SEQUENCE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.message_references_message_reference_id_seq OWNER TO ckruse;

--
-- Name: message_references_message_reference_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ckruse
--
...
--
-- Name: message_versions; Type: TABLE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.message_versions OWNER TO ckruse;

--
-- Name: message_versions_message_version_id_seq; Type: SEQUENCE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.message_versions_message_version_id_seq OWNER TO ckruse;

--
-- Name: message_versions_message_version_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ckruse
--
...
--
-- Name: messages; Type: TABLE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.messages OWNER TO ckruse;

--
-- Name: messages_message_id_seq; Type: SEQUENCE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.messages_message_id_seq OWNER TO ckruse;

--
-- Name: messages_message_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ckruse
--
...
--
-- Name: messages_tags; Type: TABLE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.messages_tags OWNER TO ckruse;

--
-- Name: messages_tags_message_tag_id_seq; Type: SEQUENCE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.messages_tags_message_tag_id_seq OWNER TO ckruse;

--
-- Name: messages_tags_message_tag_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ckruse
--
...
--
-- Name: moderation_queue; Type: TABLE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.moderation_queue OWNER TO ckruse;

--
-- Name: moderation_queue_moderation_queue_entry_id_seq; Type: SEQUENCE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.moderation_queue_moderation_queue_entry_id_seq OWNER TO ckruse;

--
-- Name: moderation_queue_moderation_queue_entry_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ckruse
--
...
--
-- Name: notifications; Type: TABLE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.notifications OWNER TO ckruse;

--
-- Name: notifications_notification_id_seq; Type: SEQUENCE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.notifications_notification_id_seq OWNER TO ckruse;

--
-- Name: notifications_notification_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ckruse
--
...
--
-- Name: opened_closed_threads; Type: TABLE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.opened_closed_threads OWNER TO ckruse;

--
-- Name: opened_closed_threads_opened_closed_thread_id_seq; Type: SEQUENCE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.opened_closed_threads_opened_closed_thread_id_seq OWNER TO ckruse;

--
-- Name: opened_closed_threads_opened_closed_thread_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ckruse
--
...
--
-- Name: priv_messages; Type: TABLE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.priv_messages OWNER TO ckruse;

--
-- Name: priv_messages_priv_message_id_seq; Type: SEQUENCE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.priv_messages_priv_message_id_seq OWNER TO ckruse;

--
-- Name: priv_messages_priv_message_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ckruse
--
...
--
-- Name: priv_messages_thread_id_seq; Type: SEQUENCE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.priv_messages_thread_id_seq OWNER TO ckruse;

--
-- Name: priv_messages_thread_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ckruse
--
...
--
-- Name: read_messages; Type: TABLE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.read_messages OWNER TO ckruse;

--
-- Name: read_messages_read_message_id_seq; Type: SEQUENCE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.read_messages_read_message_id_seq OWNER TO ckruse;

--
-- Name: read_messages_read_message_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ckruse
--
...
--
-- Name: redirections; Type: TABLE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.redirections OWNER TO ckruse;

--
-- Name: redirections_redirection_id_seq; Type: SEQUENCE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.redirections_redirection_id_seq OWNER TO ckruse;

--
-- Name: redirections_redirection_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ckruse
--
...
--
-- Name: schema_migrations; Type: TABLE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.schema_migrations OWNER TO ckruse;

--
-- Name: scores; Type: TABLE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.scores OWNER TO ckruse;

--
-- Name: scores_score_id_seq; Type: SEQUENCE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.scores_score_id_seq OWNER TO ckruse;

--
-- Name: scores_score_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ckruse
--
...
--
-- Name: search_documents; Type: TABLE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.search_documents OWNER TO ckruse;

--
-- Name: search_documents_search_document_id_seq; Type: SEQUENCE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.search_documents_search_document_id_seq OWNER TO ckruse;

--
-- Name: search_documents_search_document_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ckruse
--
...
--
-- Name: search_sections; Type: TABLE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.search_sections OWNER TO ckruse;

--
-- Name: search_sections_search_section_id_seq; Type: SEQUENCE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.search_sections_search_section_id_seq OWNER TO ckruse;

--
-- Name: search_sections_search_section_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ckruse
--
...
--
-- Name: settings; Type: TABLE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.settings OWNER TO ckruse;

--
-- Name: settings_setting_id_seq; Type: SEQUENCE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.settings_setting_id_seq OWNER TO ckruse;

--
-- Name: settings_setting_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ckruse
--
...
--
-- Name: subscriptions; Type: TABLE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.subscriptions OWNER TO ckruse;

--
-- Name: subscriptions_subscription_id_seq; Type: SEQUENCE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.subscriptions_subscription_id_seq OWNER TO ckruse;

--
-- Name: subscriptions_subscription_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ckruse
--
...
--
-- Name: tag_synonyms; Type: TABLE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.tag_synonyms OWNER TO ckruse;

--
-- Name: tag_synonyms_tag_synonym_id_seq; Type: SEQUENCE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.tag_synonyms_tag_synonym_id_seq OWNER TO ckruse;

--
-- Name: tag_synonyms_tag_synonym_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ckruse
--
...
--
-- Name: tags; Type: TABLE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.tags OWNER TO ckruse;

--
-- Name: tags_tag_id_seq; Type: SEQUENCE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.tags_tag_id_seq OWNER TO ckruse;

--
-- Name: tags_tag_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ckruse
--
...
--
-- Name: threads; Type: TABLE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.threads OWNER TO ckruse;

--
-- Name: threads_thread_id_seq; Type: SEQUENCE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.threads_thread_id_seq OWNER TO ckruse;

--
-- Name: threads_thread_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ckruse
--
...
--
-- Name: twitter_authorizations; Type: TABLE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.twitter_authorizations OWNER TO ckruse;

--
-- Name: twitter_authorizations_twitter_authorization_id_seq; Type: SEQUENCE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.twitter_authorizations_twitter_authorization_id_seq OWNER TO ckruse;

--
-- Name: twitter_authorizations_twitter_authorization_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ckruse
--
...
--
-- Name: users; Type: TABLE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.users OWNER TO ckruse;

--
-- Name: users_user_id_seq; Type: SEQUENCE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.users_user_id_seq OWNER TO ckruse;

--
-- Name: users_user_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ckruse
--
...
--
-- Name: votes; Type: TABLE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.votes OWNER TO ckruse;

--
-- Name: votes_vote_id_seq; Type: SEQUENCE; Schema: public; Owner: ckruse
--
...
ALTER TABLE public.votes_vote_id_seq OWNER TO ckruse;

--
-- Name: votes_vote_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: ckruse
--
...
--
-- Name: attendees attendee_id; Type: DEFAULT; Schema: public; Owner: ckruse
--
...
--
-- Name: auditing auditing_id; Type: DEFAULT; Schema: public; Owner: ckruse
--
...
--
-- Name: badge_groups badge_group_id; Type: DEFAULT; Schema: public; Owner: ckruse
--
...
--
-- Name: badges badge_id; Type: DEFAULT; Schema: public; Owner: ckruse
--
...
--
-- Name: badges_badge_groups badges_badge_group_id; Type: DEFAULT; Schema: public; Owner: ckruse
--
...
--
-- Name: badges_users badge_user_id; Type: DEFAULT; Schema: public; Owner: ckruse
--
...
--
-- Name: cites cite_id; Type: DEFAULT; Schema: public; Owner: ckruse
--
...
--
-- Name: cites_votes cite_vote_id; Type: DEFAULT; Schema: public; Owner: ckruse
--
...
--
-- Name: close_votes close_vote_id; Type: DEFAULT; Schema: public; Owner: ckruse
--
...
--
-- Name: close_votes_voters close_votes_voter_id; Type: DEFAULT; Schema: public; Owner: ckruse
--
...
--
-- Name: counter_table count_id; Type: DEFAULT; Schema: public; Owner: ckruse
--
...
--
-- Name: events event_id; Type: DEFAULT; Schema: public; Owner: ckruse
--
...
--
-- Name: forum_stats forum_stat_id; Type: DEFAULT; Schema: public; Owner: ckruse
--
...
--
-- Name: forums forum_id; Type: DEFAULT; Schema: public; Owner: ckruse
--
...
--
-- Name: forums_groups_permissions forum_group_permission_id; Type: DEFAULT; Schema: public; Owner: ckruse
--
...
--
-- Name: groups group_id; Type: DEFAULT; Schema: public; Owner: ckruse
--
...
--
-- Name: groups_users group_user_id; Type: DEFAULT; Schema: public; Owner: ckruse
--
...
--
-- Name: interesting_messages interesting_message_id; Type: DEFAULT; Schema: public; Owner: ckruse
--
...
--
-- Name: invisible_threads invisible_thread_id; Type: DEFAULT; Schema: public; Owner: ckruse
--
...
--
-- Name: media medium_id; Type: DEFAULT; Schema: public; Owner: ckruse
--
...
--
-- Name: message_references message_reference_id; Type: DEFAULT; Schema: public; Owner: ckruse
--
...
--
-- Name: message_versions message_version_id; Type: DEFAULT; Schema: public; Owner: ckruse
--
...
--
-- Name: messages message_id; Type: DEFAULT; Schema: public; Owner: ckruse
--
...
--
-- Name: messages_tags message_tag_id; Type: DEFAULT; Schema: public; Owner: ckruse
--
...
--
-- Name: moderation_queue moderation_queue_entry_id; Type: DEFAULT; Schema: public; Owner: ckruse
--
...
--
-- Name: notifications notification_id; Type: DEFAULT; Schema: public; Owner: ckruse
--
...
--
-- Name: opened_closed_threads opened_closed_thread_id; Type: DEFAULT; Schema: public; Owner: ckruse
--
...
--
-- Name: priv_messages priv_message_id; Type: DEFAULT; Schema: public; Owner: ckruse
--
...
--
-- Name: priv_messages thread_id; Type: DEFAULT; Schema: public; Owner: ckruse
--
...
--
-- Name: read_messages read_message_id; Type: DEFAULT; Schema: public; Owner: ckruse
--
...
--
-- Name: redirections redirection_id; Type: DEFAULT; Schema: public; Owner: ckruse
--
...
--
-- Name: scores score_id; Type: DEFAULT; Schema: public; Owner: ckruse
--
...
--
-- Name: search_documents search_document_id; Type: DEFAULT; Schema: public; Owner: ckruse
--
...
--
-- Name: search_sections search_section_id; Type: DEFAULT; Schema: public; Owner: ckruse
--
...
--
-- Name: settings setting_id; Type: DEFAULT; Schema: public; Owner: ckruse
--
...
--
-- Name: subscriptions subscription_id; Type: DEFAULT; Schema: public; Owner: ckruse
--
...
--
-- Name: tag_synonyms tag_synonym_id; Type: DEFAULT; Schema: public; Owner: ckruse
--
...
--
-- Name: tags tag_id; Type: DEFAULT; Schema: public; Owner: ckruse
--
...
--
-- Name: threads thread_id; Type: DEFAULT; Schema: public; Owner: ckruse
--
...
--
-- Name: twitter_authorizations twitter_authorization_id; Type: DEFAULT; Schema: public; Owner: ckruse
--
...
--
-- Name: users user_id; Type: DEFAULT; Schema: public; Owner: ckruse
--
...
--
-- Name: votes vote_id; Type: DEFAULT; Schema: public; Owner: ckruse
--
...
--
-- Name: ar_internal_metadata ar_internal_metadata_pkey; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: attendees attendees_event_id_user_id_key; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: attendees attendees_pkey; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: auditing auditing_pkey; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: badge_groups badge_groups_pkey; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: badges_badge_groups badges_badge_groups_pkey; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: badges badges_pkey; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: badges badges_slug_key; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: badges_users badges_users_pkey; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: cites cites_old_id_key; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: cites cites_pkey; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: cites_votes cites_votes_pkey; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: close_votes close_votes_message_id_vote_type_key; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: close_votes close_votes_pkey; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: close_votes_voters close_votes_voters_close_vote_id_user_id_key; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: close_votes_voters close_votes_voters_pkey; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: counter_table counter_table_pkey; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: events events_pkey; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: forum_stats forum_stats_forum_id_moment_key; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: forum_stats forum_stats_pkey; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: forums_groups_permissions forums_groups_permissions_pkey; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: forums forums_pkey; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: groups groups_name_key; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: groups groups_pkey; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: groups_users groups_users_pkey; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: interesting_messages interesting_messages_pkey; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: invisible_threads invisible_threads_pkey; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: media media_pkey; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: message_references message_references_dst_message_id_src_message_id_key; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: message_references message_references_pkey; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: message_versions message_versions_pkey; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: messages messages_pkey; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: messages_tags messages_tags_pkey; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: moderation_queue moderation_queue_pkey; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: notifications notifications_pkey; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: opened_closed_threads opened_closed_threads_pkey; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: priv_messages priv_messages_pkey; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: read_messages read_messages_pkey; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: redirections redirections_path_key; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: redirections redirections_pkey; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: scores scores_pkey; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: search_documents search_documents_pkey; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: search_documents search_documents_reference_id_key; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: search_documents search_documents_url_key; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: search_sections search_sections_name_key; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: search_sections search_sections_pkey; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: settings settings_pkey; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: subscriptions subscriptions_message_id_user_id_key; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: subscriptions subscriptions_pkey; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: tag_synonyms tag_synonyms_pkey; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: tags tags_pkey; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: threads threads_pkey; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: twitter_authorizations twitter_authorizations_pkey; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: twitter_authorizations twitter_authorizations_user_id_key; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: users users_pkey; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: votes votes_pkey; Type: CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: badge_groups_lower_idx; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: badges_badge_type_idx; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: cites_votes_cite_id_user_id_idx; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: counter_table_table_name_group_crit_idx; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: events_lower_idx; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: forums_slug_idx; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: index_media_on_filename; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: invisible_threads_thread_id_user_id_idx; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: messages_editor_id_idx; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: messages_forum_id_created_at_idx; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: messages_mid_idx; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: messages_parent_id_idx; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: messages_tags_message_id_idx; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: messages_tags_tag_id_message_id_idx; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: messages_thread_id_idx; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: messages_updated_at_idx; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: messages_user_id_idx; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: moderation_queue_message_id_idx; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: notifications_recipient_id_oid_idx; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: opened_closed_threads_thread_id_user_id_idx; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: priv_messages_owner_id_idx; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: priv_messages_recipient_id_idx; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: priv_messages_sender_id_idx; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: read_messages_message_id_user_id_idx; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: read_messages_user_id_idx; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: scores_user_id_message_id_idx; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: scores_user_id_vote_id_idx; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: search_documents_author_idx; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: search_documents_content_idx; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: search_documents_document_created_idx; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: search_documents_document_idx; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: search_documents_tags_idx; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: search_documents_title_idx; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: search_documents_user_id_idx; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: settings_forum_id_idx; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: settings_forum_id_user_id_idx; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: settings_user_id_idx; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: tag_synonyms_forum_id_synonym_idx; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: tag_synonyms_synonym_idx; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: tag_synonyms_tag_id_idx; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: tags_forum_id_idx; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: tags_tag_name_forum_id_idx; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: threads_archived_idx; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: threads_created_at_idx; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: threads_forum_id_idx; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: threads_message_id_idx; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: threads_slug_idx; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: threads_sticky_created_at_idx; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: threads_tid_idx; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: unique_schema_migrations; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: users_authentication_token_idx; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: users_confirmation_token_idx; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: users_email_idx; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: users_reset_password_token_idx; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: users_username_idx; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: votes_user_id_message_id_idx; Type: INDEX; Schema: public; Owner: ckruse
--
...
--
-- Name: messages messages__cache_activity_delete_trg; Type: TRIGGER; Schema: public; Owner: ckruse
--
...
--
-- Name: messages messages__cache_activity_insert_update_trg; Type: TRIGGER; Schema: public; Owner: ckruse
--
...
--
-- Name: messages messages__count_delete_trigger; Type: TRIGGER; Schema: public; Owner: ckruse
--
...
--
-- Name: forums messages__count_insert_forum_trigger; Type: TRIGGER; Schema: public; Owner: ckruse
--
...
--
-- Name: messages messages__count_insert_trigger; Type: TRIGGER; Schema: public; Owner: ckruse
--
...
--
-- Name: messages messages__count_truncate_trigger; Type: TRIGGER; Schema: public; Owner: ckruse
--
...
--
-- Name: messages messages__count_update_trigger; Type: TRIGGER; Schema: public; Owner: ckruse
--
...
--
-- Name: messages messages__thread_set_latest_trigger_insert; Type: TRIGGER; Schema: public; Owner: ckruse
--
...
--
-- Name: messages messages__thread_set_latest_trigger_update; Type: TRIGGER; Schema: public; Owner: ckruse
--
...
--
-- Name: messages_tags messages_tags__count_delete_trigger; Type: TRIGGER; Schema: public; Owner: ckruse
--
...
--
-- Name: messages_tags messages_tags__count_insert_trigger; Type: TRIGGER; Schema: public; Owner: ckruse
--
...
--
-- Name: scores scores__cache_scores_delete_trg; Type: TRIGGER; Schema: public; Owner: ckruse
--
...
--
-- Name: scores scores__cache_scores_insert_trg; Type: TRIGGER; Schema: public; Owner: ckruse
--
...
--
-- Name: scores scores__cache_scores_update_trg; Type: TRIGGER; Schema: public; Owner: ckruse
--
...
--
-- Name: search_documents search_documents__before_insert_trigger; Type: TRIGGER; Schema: public; Owner: ckruse
--
...
--
-- Name: search_documents search_documents__before_update_trigger; Type: TRIGGER; Schema: public; Owner: ckruse
--
...
--
-- Name: settings settings_unique_check_insert; Type: TRIGGER; Schema: public; Owner: ckruse
--
...
--
-- Name: settings settings_unique_check_update; Type: TRIGGER; Schema: public; Owner: ckruse
--
...
--
-- Name: threads threads__count_delete_trigger; Type: TRIGGER; Schema: public; Owner: ckruse
--
...
--
-- Name: forums threads__count_insert_forum_trigger; Type: TRIGGER; Schema: public; Owner: ckruse
--
...
--
-- Name: threads threads__count_insert_trigger; Type: TRIGGER; Schema: public; Owner: ckruse
--
...
--
-- Name: threads threads__count_truncate_trigger; Type: TRIGGER; Schema: public; Owner: ckruse
--
...
--
-- Name: threads threads__count_update_trigger; Type: TRIGGER; Schema: public; Owner: ckruse
--
...
--
-- Name: attendees attendees_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: attendees attendees_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: auditing auditing_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: badges_badge_groups badges_badge_groups_badge_group_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: badges_badge_groups badges_badge_groups_badge_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: badges_users badges_users_badge_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: badges_users badges_users_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: cites cites_creator_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: cites cites_message_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: cites cites_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: cites_votes cites_votes_cite_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: cites_votes cites_votes_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: close_votes close_votes_message_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: close_votes_voters close_votes_voters_close_vote_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: forum_stats forum_stats_forum_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: forums_groups_permissions forums_groups_permissions_forum_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: forums_groups_permissions forums_groups_permissions_group_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: groups_users groups_users_group_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: groups_users groups_users_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: interesting_messages interesting_messages_message_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: interesting_messages interesting_messages_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: invisible_threads invisible_threads_thread_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: invisible_threads invisible_threads_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: media media_owner_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: message_references message_references_dst_message_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: message_references message_references_src_message_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: message_versions message_versions_message_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: message_versions message_versions_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: messages messages_editor_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: messages messages_forum_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: messages messages_parent_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: messages_tags messages_tags_message_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: messages_tags messages_tags_tag_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: messages messages_thread_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: messages messages_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: moderation_queue moderation_queue_closer_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: moderation_queue moderation_queue_message_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: notifications notifications_recipient_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: opened_closed_threads opened_closed_threads_thread_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: opened_closed_threads opened_closed_threads_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: priv_messages priv_messages_owner_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: priv_messages priv_messages_recipient_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: priv_messages priv_messages_sender_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: read_messages read_messages_message_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: read_messages read_messages_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: scores scores_message_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: scores scores_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: scores scores_vote_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: search_documents search_documents_forum_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: search_documents search_documents_search_section_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: search_documents search_documents_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: search_sections search_sections_forum_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: settings settings_forum_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: settings settings_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: subscriptions subscriptions_message_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: subscriptions subscriptions_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: tag_synonyms tag_synonyms_forum_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: tag_synonyms tag_synonyms_tag_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: tags tags_forum_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: threads threads_forum_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: threads threads_message_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: twitter_authorizations twitter_authorizations_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: votes votes_message_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
...
--
-- Name: votes votes_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: ckruse
--
